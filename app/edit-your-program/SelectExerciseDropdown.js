...
const SelectExerciseDropdown = ({ label, options, placeholder, defaultValue }) => {
    const [isOpen, setIsOpen] = useState(false);
    const [selectedOption, setSelectedOption] = useState(defaultValue || null); // Initialize with defaultValue
