                    ...
                    <tbody>
                        <tr className="h-[100px]">
                            <td className="px-6 w-full min-w-[300px] 2xl:max-w-[425px]">
                                <SelectExerciseDropdown label="Select exercise" options={typesOptions} placeholder="Select exercise" />
                            </td>
                            <td className="px-6 w-full max-w-[209px]">
                                <div className="flex items-center px-5 border border-[#EBEBEB] w-[161px] h-[56px] rounded-[50px]">
                                    <h2 className="text-[#292933] text-[16px] leading-[22px] font-normal">5</h2>
                                </div>
                            </td>
                            <td className="px-6 w-full max-w-[209px]">
                                <div className="flex items-center px-5 border border-[#EBEBEB] w-[161px] h-[56px] rounded-[50px]">
                                    <h2 className="text-[#292933] text-[16px] leading-[22px] font-normal">3</h2>
                                </div>
                            </td>
                            <td className="px-6 w-full max-w-[209px]">
                                <div className="flex items-center px-5 border border-[#EBEBEB] w-[161px] h-[56px] rounded-[50px]">
                                    <h2 className="text-[#292933] text-[16px] leading-[22px] font-normal">75%</h2>
                                </div>
                            </td>
                            <td className="px-6 w-full max-w-[210px]">
                                <div className="flex items-center px-5 border border-[#EBEBEB] w-[161px] h-[56px] rounded-[50px]">
                                    <h2 className="text-[#292933] text-[16px] leading-[22px] font-normal">60</h2>
                                </div>
                            </td>
                ...
                <div className='w-full bg-[#FFFFFF] rounded-[10px] py-6 px-3'>
                    ...
                    <div className='mt-6 flex items-start overflow-x-auto'>
                        <div className='border-r border-[#D9D9D9] pr-[16px]'>
                            ...
                            <h3 className='text-black/60 text-[14px] leading-[17.5px] font-normal'>5</h3>
                        </div>
                        <div className='border-r border-[#D9D9D9] px-[16px]'>
                            ...
                            <h3 className='text-black/60 text-[14px] leading-[17.5px] font-normal'>3</h3>
                        </div>
                        <div className='border-r border-[#D9D9D9] px-[16px]'>
                            <h3 className='text-[#7F7F8A] text-[14px] leading-[18px] font-medium uppercase mb-2.5'>Weight/time</h3>
                            <h3 className='text-black/60 text-[14px] leading-[17.5px] font-normal'>75%</h3>
                        </div>
                        <div className='px-[16px]'>
                            <h3 className='text-[#7F7F8A] text-[14px] leading-[18px] font-medium uppercase mb-2.5'>Rest</h3>
                            <h3 className='text-black/60 text-[14px] leading-[17.5px] font-normal'>60s</h3>
                        </div>
                    </div>
